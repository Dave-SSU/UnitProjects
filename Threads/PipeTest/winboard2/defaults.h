...
#define MESSAGE_LINE_LEFTMARGIN 8
...
#define ICS_NAMES \
  ...
  "eics.daimi.aau.dk /icsport=5000 /icshelper=timeseal\n" \
  "primrose.warwick.ac.uk /icsport=5000 /icshelper=timeseal\n" \
  "fly.cc.fer.hr /icsport=7890\n" \
  "dics.dds.nl /icsport=5000 /icshelper=timeseal\n" \
  "chess.eerie.fr /icsport=5000 /icshelper=timeseal\n" \
  "chess.etud.insa-tlse.fr /icsport=5000 /icshelper=timeseal\n" \
  "chess.unix-ag.uni-kl.de /icsport=5000 /icshelper=timeseal\n" \
  "chess.mds.mdh.se /icsport=5555 /icshelper=timeseal\n" \
  "chess.mds.mdh.se /icsport=5000\n" \
  "vics.ver.ucc.mx /icsport=5000\n" \
  "ics.interdomain.net.au /icsport=5000\n" \
  "fics.infcom.it /icsport=5000\n" \
  "queen.chessclub.com /icsport=5000 /icshelper=timestamp\n" \
  "rook.chessclub.com /icsport=5000 /icshelper=timestamp\n" \
...
#define BUILT_IN_SOUND_NAMES {\
  ...
  "Slap", "Squeak", "Swish", "Thud", "Whipcrack", NULL \
}
...
#define FCP_NAMES \
  "GNUChess\n" \
  "WCrafty /fd=\"C:\\Program Files\\Crafty\"\n"
#define SCP_NAMES \
  "GNUChess\n" \
  "WCrafty /sd=\"C:\\Program Files\\Crafty\"\n"
#else
#define FCP_NAMES \
  "GNUChess\n"
#define SCP_NAMES \
